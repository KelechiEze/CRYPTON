...
import { LayoutDashboard, Wallet, User, Settings, ArrowLeftRight, LogOut, X, Pickaxe } from 'lucide-react';
...
const navItems = [
  ...
  { icon: Wallet, name: 'Wallets', path: '/dashboard/wallets' },
  { icon: ArrowLeftRight, name: 'Transactions', path: '/dashboard/transactions' },
  { icon: Pickaxe, name: 'Mine', path: '/dashboard/mine' },
  { icon: User, name: 'Profile', path: '/dashboard/profile' },
  { icon: Settings, name: 'Settings', path: '/dashboard/settings' },
];

const Sidebar: React.FC<SidebarProps> = ({ isOpen, setIsOpen, handleLogout }) => {
