...
import { ArrowUpRight, ArrowDownRight, TrendingUp, DollarSign, Bitcoin, Zap, BarChart, ShieldCheck, Gift, CheckCircle, X, ArrowUp, ArrowDown, RefreshCw, TrendingUp as TrendingUpIcon, Brain, AlertTriangle, Play, Pause, Wallet, Circle } from 'lucide-react';
        ...
        const loadSpinData = async () => {
            ...
            if (user) {
                ...
                if (spinData) {
                    ...
                    // Initialize with 1 spin per month
                    setSpinsLeft(1);
                    const nextDate = new Date();
                    nextDate.setMonth(nextDate.getMonth() + 1);
                    setNextSpinDate(nextDate.toISOString());
                }
            }
        };
        loadSpinData();
            ...
            <div className="group relative w-full bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-lg">
                ...
                <div className="relative flex justify-center items-center mb-6">
                    <div className="relative w-64 h-64">
                        ...
                        <div 
                            ref={wheelRef}
                            className="w-full h-full rounded-full border-4 border-gray-300 dark:border-gray-600 relative overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800"
                        >
                            ...
                            {/* Center Circle */}
                            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-white dark:bg-gray-800 rounded-full border-4 border-gray-300 dark:border-gray-600 z-10 flex items-center justify-center">
                ...
                <div className="mt-4 grid grid-cols-2 gap-2">
                    {wheelRewards.slice(0, 4).map((reward) => {
                        const IconComponent = reward.icon;
                        return (
                            <div key={reward.id} className="flex items-center gap-2 p-2 bg-white/50 dark:bg-gray-700/50 rounded-lg">
